...
const content = {
  ...
  lancamento: {
    titulo: '⏳ Prezzo speciale di lancio',
    texto: (v) =>
      `I prezzi di ${v.mirim} e ${v.mega} valgono fino al ${v.data} (ora di Brasilia). Dopo, i kit costeranno ${v.depoisMirim} e ${v.depoisMega}.`,
    unidades: ['giorni', 'ore', 'min', 'sec'],
