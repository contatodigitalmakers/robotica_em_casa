...
const content = {
  ...
  lancamento: {
    titulo: '⏳ Prix spécial de lancement',
    texto: (v) =>
      `Les prix de ${v.mirim} et ${v.mega} sont valables jusqu’au ${v.data} (heure de Brasília). Ensuite, les kits passeront à ${v.depoisMirim} et ${v.depoisMega}.`,
    unidades: ['jours', 'heures', 'min', 's'],
